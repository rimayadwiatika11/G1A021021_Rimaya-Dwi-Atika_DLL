// Program C++ yang berfungsi lengkap untuk
//mendemonstrasikan semua metode penyisipan
...
int main()
{
	...
	// Insert 19. Daftar tertaut akan menjadi 19->NULL
	append(&head, 19);

	// Insert 8 di awalnya.
	// Daftar tertaut akan menjadi 8->19->NULL
	push(&head, 8);

	// Insert 3 di awalnya.
	// Daftar tertaut akan menjadi 3->8->19->NULL
	push(&head, 3);

	// Insert 30 pada akhirannya. 
	// Daftar tertaut akan menjadi 3->8->19->30->NULL
	append(&head, 30);

	// Insert 6, setelah 5. 
	// Daftar tertaut akan menjadi 3->8->11->19->30->NULL
